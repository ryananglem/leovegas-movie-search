...
<AboutContainer>
    ...
    <li>It should also have functionality for setting movies as your favourites, maybe with a star
    symbol in the table.</li>
    <li>A list where you can add movies you want to watch, like the “watch later” functionality on
    YouTube.</li>
    <li>Make Sure to test the application and write the tests in the Repo.</li>
    <li>The App Must Be working on desktop as well as mobile.</li>
    <li>Posters and trailers are always nice, this is however up to you.(Optional)</li>
    <li>Last but definitely NOT least, please include a Demo for us to see.</li>
    </ul>
    </p>
    <p>
